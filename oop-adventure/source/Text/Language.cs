...
{
    public string ChooseLanguage { get; protected set; } = "";
    ...
    public string ChooseYourAge { get; protected set; } = "";
    public string DefaultAge { get; protected set; } = "";
    ...
    public string Also { get; protected set; } = "";
    public string IsHere { get; protected set; } = "";
    ...
    public string TalkBarryResponse { get; protected set; } = ""; 
    public string TalkNoResponse { get; protected set; } = "";
    public string TalkError { get; protected set; } = "";

    public string DontCrossNPCName { get; protected set; } = "";
    public string YouDied { get; protected set; } = "";
    public string YouAreDead { get; protected set; } = "";
    
    public string Knife { get; protected set; } = "";
    public string Attack { get; protected set; } = "";
    public string Attacked { get; set; } = "";
    public string AttackError { get; protected set; } = "";
